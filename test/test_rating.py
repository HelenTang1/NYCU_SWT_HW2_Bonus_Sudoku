...
def test_rating_easy(easy_grid):
    assert get_rating(easy_grid) == Rank.EASY



def test_rating_medium(medium_grid):
    assert get_rating(medium_grid) == Rank.MEDIUM

def test_rating_hard(hard_grid):
    assert get_rating(hard_grid) == Rank.HARD